...
import com.microservices.demo.twitter.to.kafka.service.listener.TwitterStatusKafkaListener;
...
@ConditionalOnProperty(name = "twitter.enable-mock-tweets", havingValue = "true")
public class MockKafkaStreamRunner implements StreamRunner {
    private final TwitterStatusKafkaListener twitterKafkaStatusListener;
